...
public class PlayerCollisionCheckWithITC : MonoBehaviour
{
    ...
    _textPickUpInfo.text = "CAPSULE_OBSTACLE has been picked up";
     ...
     break;
     case ItemType.JAR_OBSTACLE:
     _textPickUpInfo.text = "JAR_OBSTACLE has been picked up";
     break;
     case ItemType.DONUT_OBSTACLE:
     _textPickUpInfo.text = "DONUT_OBSTACLE has been picked up";
     break;
            }
